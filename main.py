...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="EdgeDistillDet",
        description="面向边缘计算的微小目标自适应蒸馏与检测评估系统",
    ...
    p_eval.add_argument("--config", default="configs/eval_config.yaml",
                        help="评估配置文件路径")
    ...
    p_prof.add_argument("--device", default="rk3588",
                        choices=["rk3588", "ascend310", "cpu", "gpu"],
                        help="目标边缘设备类型")
