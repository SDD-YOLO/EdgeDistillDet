...
def main() -> int:
    ...
    save_txt = _coerce_bool(payload.get("save_txt") or _get_config_value(cfg, [["predict", "save_txt"], ["advanced", "training", "save_txt"]]))
    save_conf = _coerce_bool(payload.get("save_conf") or _get_config_value(cfg, [["predict", "save_conf"], ["advanced", "training", "save_conf"]]))
    save_crop = _coerce_bool(payload.get("save_crop") or _get_config_value(cfg, [["predict", "save_crop"], ["advanced", "training", "save_crop"]]))
    show_labels = _coerce_bool(payload.get("show_labels") or _get_config_value(cfg, [["predict", "show_labels"], ["advanced", "training", "show_labels"]]))
    show_conf = _coerce_bool(payload.get("show_conf") or _get_config_value(cfg, [["predict", "show_conf"], ["advanced", "training", "show_conf"]]))
    show_boxes = _coerce_bool(payload.get("show_boxes") or _get_config_value(cfg, [["predict", "show_boxes"], ["advanced", "training", "show_boxes"]]))
    line_width = (
    ...
    visualize = _coerce_bool(payload.get("visualize") or _get_config_value(cfg, [["predict", "visualize"], ["advanced", "training", "visualize"]]))
    show = _coerce_bool(payload.get("show") or _get_config_value(cfg, [["predict", "show"], ["advanced", "training", "show"]]))
