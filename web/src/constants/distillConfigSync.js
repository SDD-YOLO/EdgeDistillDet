...
export const DISTILL_CONFIG_UPDATED_EVENT = "edgedistill-distill-config-updated";
...
export function broadcastDistillConfigUpdate(config, source, extra = {}) {
  ...
  window.dispatchEvent(new CustomEvent(DISTILL_CONFIG_UPDATED_EVENT, { detail: { config, source, ...extra } }));
}
