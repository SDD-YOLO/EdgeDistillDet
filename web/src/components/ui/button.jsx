...
const Button = forwardRef(function Button(
  ...
  const mergedClassName = legacy
    ? legacyClassName(variant, size, className)
    : modernClassName(variant, size, className);
  ...
  return (
    ...
    >
      ...
      <span className={loading ? "btn-content is-loading" : "btn-content"}>
        {children}
      </span>
    </button>
  );
